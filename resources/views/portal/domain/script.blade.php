...
jQuery(document).ready(function($) {
    ...
    $('#openaddmodel').on('show.bs.modal', function (e) {

        var test = flatpickr("#expire_at");

        flatpickr('.pickdate',{ 'static': true });
