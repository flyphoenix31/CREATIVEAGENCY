        ...
        <div class="conversation-list">
            <div class="chat-avatar">
                @if ($message->from_user == Auth::id())
                    <img src="{{ Auth::user()->thumb }}" alt="" class="imgavatar lazy">
                @else
                    <img src="{{ $chatUser->thumb }}" alt="" class="lazy">
                @endif
            </div>
                ...
                <div class="ctext-wrap">
                    <div class="ctext-wrap-content">
                        @if ($message->file)
                            ...
                            @endif
                        @else
                            <p class="mb-0 chatmessage" id="aaa">
                                {{ $message->message }}
                            </p>
                        @endif
                    ...
                    <div class="dropdown align-self-start">
                       ...
                       {{--  <a class="dropdown-toggle" href="#" role="button" id="pendingTask" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="pendingTask" style="will-change: transform;" id="folderaction">
                            <a class="dropdown-item" href="javascript:void(0);" data-id="34" id="callFolderDelFunc">Delete</a>
                        </div>--}}
