...
$('#formedit').on('submit', function(event){
    ...
    $.ajax( {
        ...
        success: function ( response ) {
            ...
            {
                swal( '@lang("lang.done")', '@lang("lang.record_update_success_msg")', "success" );
...
function calculateitemsubtotal(target)
{
    var unit_price = $('input[data-id=unit_price_'+target+']').val();
    var quantity = $('input[data-id=quantity_'+target+']').val();
...
var items = {!! json_encode($record->items->toArray()) !!};

$.each( items, function( key, value )
{
    additmeswithdata(key, value);

    calculateitemsubtotal(key);
});
