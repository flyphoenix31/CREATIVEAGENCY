...
(function ($) {
  ...
  $("body").on("click", "#deleteContact", function (e) {
    ...
    $.ajax({
      url: url.href,
      //or you can useurl: "chat/users/"+id,
      type: "DELETE",
      data: {
        _token: token,
        id: id
  ...
  */
  ...
  $(document).on("change", "#fileUpload", function (e) {
    ...
    const fileSize = abcfiles.size / 1024 / 1024; // in MiB
    if (fileSize > 2) {
  ...
  */
  ...
  function getgrouplastmessage(data) {
    $.ajax({
      type: "get",
     url: "chat/grouplastmessage/" + data,
      // need to create this route
      data: "",
      cache: false,
      success: function success(data) {
  ...
  */
  ...
  function loademoji() {
    ...
    window.emojiPicker = new EmojiPicker({
      ...
      assetsPath: "cchat/vendor/emoji-picker/lib/img/",
